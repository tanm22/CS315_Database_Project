...
<section class="about">
    <div class="row">
        ...
        <div class="content">
            <h3>Team Message:</h3>
            <p>Hey There! We are a group of students of B.Tech in Computer Science Engineering Department from IIT Kanpur College [Batch: 2022]. We love designing websites and exploring new things. Learning new things is our hobby.</p>
            <p>I would like to thank <a href="https://www.iitk.ac.in/new/arnab-bhattacharya" target="_blank">Prof. Arnab Bhattacharya</a> Sir for guiding us through the concept of course CS315 Database and Management, helping us to develop projects like this.</p>
    ...
    <div class="swiper reviews-slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
                ...
                <p>KinBech is cool! I have ordered hundreds of products from it and never got any scam. It delivers products in time without delay. Packaging of products are strong and delivery rates are too low. Just amazing Website will keep shopping from KinBech.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
